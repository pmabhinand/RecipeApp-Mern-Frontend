...
<div className='mt-5 mb-5' id='kitchenUtensils'>
    <h1 className='text-center text-dark' style={{fontSize:'55px'}}>Cooking Tools & Kitchen Utensils</h1>
      ...
      <Row className='mt-5 ps-5 pe-5'>
        ...
        <Col lg={6} className='mb-5'>
            ...
            <img className='mb-3' src="https://www.mealime.com/_next/image?url=%2Fimages%2Fkitchen-essentials%2FSpatula-300x129.jpg&w=384&q=85" alt="" style={{width:'15rem',height:'8rem'}} />
            <a className='btn btn-dark ms-3' href="https://www.amazon.com/gp/product/B0071JZF44/ref=as_li_ss_tl?ie=UTF8&linkCode=sl1&tag=mealime-20&linkId=HKIS344UNHHOJ3Y3" target='_blank'>Buy from <span className='fw-bold'>Amazon</span></a>
        </Col>
        ...
        <Col lg={6} className='mb-5'>
            ...
            <img className='mb-3' src="https://www.mealime.com/_next/image?url=%2Fimages%2Fkitchen-essentials%2FStirring-Spoon-300x195.jpg&w=384&q=85" alt="" style={{width:'15rem',height:'8rem'}} />
            <a className='btn btn-dark ms-3' href="https://www.amazon.com/gp/product/B000X7FOI8/ref=as_li_ss_tl?ie=UTF8&linkCode=sl1&tag=mealime-20&linkId=D6XN6LLLGF3J3QS5" target='_blank'>Buy from <span className='fw-bold'>Amazon</span></a>
        </Col>
        ...
        <Col lg={6} className='mb-5'>
            ...
            <img className='mb-3' src="https://www.mealime.com/_next/image?url=%2Fimages%2Fkitchen-essentials%2FOven-Mitts-300x207.jpg&w=384&q=85" alt="" style={{width:'15rem',height:'8rem'}} />
            <a className='btn btn-dark ms-3' href="https://www.amazon.com/gp/product/B004QGXNT4/ref=as_li_ss_tl?ie=UTF8&linkCode=sl1&tag=mealime-20&linkId=2EJ6H4RNKJDYEGAB" target='_blank'>Buy from <span className='fw-bold'>Amazon</span></a>
        </Col>
        ...
        <Col lg={6} className='mb-5'>
            ...
            <img className='mb-3' src="https://www.mealime.com/_next/image?url=%2Fimages%2Fkitchen-essentials%2FTrivet-300x300.jpg&w=384&q=85" alt="" style={{width:'15rem',height:'8rem'}} />
            <a className='btn btn-dark ms-3' href="https://www.amazon.com/Bambri%C2%AE-HP03P-Resistant-Trivets-Kitchen/dp/B0132TJ3TO/ref=as_li_ss_tl?ie=UTF8&qid=1443030287&sr=8-1&keywords=Bamboo+Hot+Pad+Trivet&linkCode=sl1&tag=mealime-20&linkId=9fbbe1ca8d8f46efa442da124f75af81" target='_blank'>Buy from <span className='fw-bold'>Amazon</span></a>
        </Col>
