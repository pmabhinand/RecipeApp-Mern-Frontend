      ...
      <Row>
        ...
        <Col lg={6}>
          <div className='ps-3'>
            ...
            <img src="https://www.mealime.com/_next/image?url=%2Fimages%2Fkitchen-essentials%2FCast-Iron-Skillet-300x136.jpg&w=384&q=85" alt="" style={{width:'15rem',height:'8rem'}} />
            <a className='btn btn-dark ms-5' href="https://www.amazon.com/gp/product/B00006JSUB/ref=as_li_ss_tl?ie=UTF8&linkCode=sl1&tag=mealime-20&linkId=RXPD7CQVZC7OHKXU" target='_blank'>Buy from <span className='fw-bold'>Amazon</span></a>
          </div>
        </Col>
        ...
        <Col lg={6}>
          <div className='ps-3 mt-5'>
            ...
            <img src="https://www.mealime.com/_next/image?url=%2Fimages%2Fkitchen-essentials%2FMuffin-Pan.jpg&w=384&q=85" alt="" style={{width:'15rem',height:'8rem'}} />
            <a className='btn btn-dark ms-5' href="https://www.amazon.com/gp/product/B015CQZR6I/ref=as_li_tl?ie=UTF8&tag=mealime-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=B015CQZR6I&linkId=fff7f487639375b8fe6e799a1f87d1ee" target='_blank'>Buy from <span className='fw-bold'>Amazon</span></a>
          </div>
        </Col>
