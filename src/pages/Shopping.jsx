      ...
      <Row>
        ...
        <Col lg={6}>
          <div className='pe-3'>
            ...
            <img src="https://www.mealime.com/_next/image?url=%2Fimages%2Fkitchen-essentials%2FChefs-Knife-Budget-Victorinox-Fibrox.jpg&w=384&q=85" alt="" style={{width:'15rem',height:'8rem'}} />
            <a className='btn btn-dark ms-5' href="https://www.amazon.com/dp/B008M5U1C2/ref=as_li_ss_tl?ie=UTF8&linkCode=sl1&tag=mealime-20&linkId=0fab7a70b4a1a29671730156c002aa94" target='_blank'>Buy from <span className='fw-bold'>Amazon</span></a>
          </div>
        </Col>
        ...
        <Col lg={6}>
          <div className='ps-3'>
            ...
            <img src="https://www.mealime.com/_next/image?url=%2Fimages%2Fkitchen-essentials%2FCan-Opener-300x200.jpg&w=384&q=85" alt="" style={{width:'15rem',height:'8rem'}} />
            <a className='btn btn-dark ms-5' href="https://www.amazon.com/gp/product/B000B6NXL6/ref=as_li_ss_tl?ie=UTF8&linkCode=sl1&tag=mealime-20&linkId=ADU4ZBVOEQPBEUIX" target='_blank'>Buy from <span className='fw-bold'>Amazon</span></a>
          </div>
        </Col>
        ...
        <Col lg={6}>
          <div className='pe-3 mt-5'>
            ...
            <img src="https://www.mealime.com/_next/image?url=%2Fimages%2Fkitchen-essentials%2FMeasuring-Spoons-300x173.jpg&w=384&q=85" alt="" style={{width:'15rem',height:'8rem'}} />
            <a className='btn btn-dark ms-5' href="https://www.amazon.com/gp/product/B001GAQKKW/ref=as_li_ss_tl?ie=UTF8&linkCode=sl1&tag=mealime-20&linkId=XCB3ZW5GH37AUOFL" target='_blank'>Buy from <span className='fw-bold'>Amazon</span></a>
          </div>
        </Col>
        ...
        <Col lg={6}>
          <div className='ps-3 mt-5'>
            ...
            <img src="https://www.mealime.com/_next/image?url=%2Fimages%2Fkitchen-essentials%2FVegetable-Peeler-300x196.jpg&w=384&q=85" alt="" style={{width:'15rem',height:'8rem'}} />
            <a className='btn btn-dark ms-5' href="https://www.amazon.com/gp/product/B0028RXHKS/ref=as_li_ss_tl?ie=UTF8&linkCode=sl1&tag=mealime-20&linkId=OFK5YS5B5YXIWKKC" target='_blank'>Buy from <span className='fw-bold'>Amazon</span></a>
          </div>
        </Col>
